#include "libsersi/minefield/MinefieldDataPdu.h"
...
void MinefieldDataPdu::Marshal(ByteBuffer& byte_buffer) const {
  MinefieldFamilyPdu::Marshal(byte_buffer);
  minefield_id_.Marshal(byte_buffer);
  requesting_entity_id_.Marshal(byte_buffer);
  byte_buffer << minefield_sequence_number_;
  byte_buffer << request_id_;
  byte_buffer << pdu_sequence_number_;
  byte_buffer << number_of_pdus_;
  byte_buffer << static_cast<uint8_t>(mine_location_.size());
  byte_buffer << static_cast<uint8_t>(sensor_types_.size());
  byte_buffer << pad2_;
  byte_buffer << data_filter_;
  mine_type_.Marshal(byte_buffer);
...
void MinefieldDataPdu::Unmarshal(ByteBuffer& byte_buffer) {
  ...
  byte_buffer >> pdu_sequence_number_;
  byte_buffer >> number_of_pdus_;
  byte_buffer >> number_of_mines_in_this_pdu_;
  byte_buffer >> number_of_sensor_types_;
  byte_buffer >> pad2_;
  byte_buffer >> data_filter_;
  mine_type_.Unmarshal(byte_buffer);
