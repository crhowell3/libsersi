#include simulation_management_reliable/CommentReliablePdu.h"
...
void CommentReliablePdu::Marshal(ByteBuffer& byte_buffer) const {
...
void CommentReliablePdu::Unmarshal(ByteBuffer& byte_buffer) {
