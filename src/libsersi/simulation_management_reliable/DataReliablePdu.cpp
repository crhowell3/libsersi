#include "libsersi/simulation_management_reliable/DataReliablePdu.h"
...
void DataReliablePdu::Marshal(ByteBuffer& byte_buffer) const {
...
void DataReliablePdu::Unmarshal(ByteBuffer& byte_buffer) {
