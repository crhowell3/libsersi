#include "libdis6/simulation_management/DataPdu.h"
...
uint32_t DataPdu::GetRequestId() const { return request_id_; }

void DataPdu::SetRequestId(uint32_t value) { request_id_ = value; }

uint32_t DataPdu::GetPadding1() const { return padding1_; }

void DataPdu::SetPadding1(uint32_t value) { padding1_ = value; }
...
std::vector<FixedDatum>& DataPdu::GetFixedDatums() { return fixed_datums_; }

const std::vector<FixedDatum>& DataPdu::GetFixedDatums() const {
  return fixed_datums_;
}

void DataPdu::SetFixedDatums(const std::vector<FixedDatum>& value) {
  fixed_datums_ = value;
}
...
void DataPdu::SetVariableDatums(const std::vector<VariableDatum>& value) {
...
std::size_t DataPdu::GetMarshalledSize() const {
